...
const Navbar = () => {
  ...
  // added state to handle dropdowns
  const [dropdown, setDropdown] = useState(null);

  // Toggle Function
  const toggleFunction = (menu) => {
  ...
  return (
    <div className='w-full'>
        ...
        <div className='bg-gray-100 py-4 flex items-center justify-between px-4'>
            ...
            <p className='text-center hover:underline font-medium'>| For International Orders and Express Shipping Contact Us |</p>
      ...
      <nav className='border-t border-b border-gray-200'>
        ...
        <li className='hover:underline transition-colors'>
          <a href="/" className='block px-2'>Home</a>
        </li>
        <li className='hover:underline transition-colors flex items-centre'>
          <Link to="/our-story" className='block px-2'>Our Story</Link>
        </li>
        
        <li className='hover:underline transition-colors flex items-center'>
